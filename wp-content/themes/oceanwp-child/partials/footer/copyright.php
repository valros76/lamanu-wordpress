...
// Get copyright text.
$copy = get_theme_mod( 'ocean_footer_copyright_text', '© Webdevoo - 2021' );
	...
	<div id="footer-bottom-inner" class="container clr">
		...
		if ( $copy ) :
			...
			<div id="copyright" class="clr" role="contentinfo">
				<a href="https://webdevoo.com" target="_blank" rel="noopener noreferrer"><?php echo wp_kses_post( do_shortcode( $copy ) ); ?></a>
			</div><!-- #copyright -->
